    ...
    <body>
        ...
        <div class="section secondary-section " id="portfolio">
            ...
            <div class="container">
                ...
                <form action = "textSearching.php" name="searchForm" method = "POST" >
                    <table align="center" border="0" cellpadding="10" cellspacing="10">
                        <tr>
                            <th>Your Query : </th>
                            <td>
                                <textarea rows="2" cols="50" name="query" placeholder="Enter minimum 4-letter word for effifcient searching" required/></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th>Search : </th>
